...
#define IPI_CORE0_CONTROL           (PA_LOCAL_PERIPHERAL_BASE + IPI_CORE0_CONTROL_OFFSET)
#define IPI_CORE1_CONTROL           (PA_LOCAL_PERIPHERAL_BASE + IPI_CORE1_CONTROL_OFFSET)
#define IPI_CORE2_CONTROL           (PA_LOCAL_PERIPHERAL_BASE + IPI_CORE2_CONTROL_OFFSET)
#define IPI_CORE3_CONTROL           (PA_LOCAL_PERIPHERAL_BASE + IPI_CORE3_CONTROL_OFFSET)
...
#define CORE0_IRQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x60)
#define CORE1_IRQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x64)
#define CORE2_IRQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x68)
#define CORE3_IRQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x6C)

#define CORE0_FIQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x70)
#define CORE1_FIQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x74)
#define CORE2_FIQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x78)
#define CORE3_FIQ_SOURCE        (PA_LOCAL_PERIPHERAL_BASE + 0x7C)
...
#define IPI_CORE0_SET_BASE      (PA_LOCAL_PERIPHERAL_BASE + 0x80)
#define IPI_CORE1_SET_BASE      (PA_LOCAL_PERIPHERAL_BASE + 0x90)
#define IPI_CORE2_SET_BASE      (PA_LOCAL_PERIPHERAL_BASE + 0xa0)
#define IPI_CORE3_SET_BASE      (PA_LOCAL_PERIPHERAL_BASE + 0xb0)
...
#define IPI_CORE0_RD_CLR_BASE   (PA_LOCAL_PERIPHERAL_BASE + 0xC0)
#define IPI_CORE1_RD_CLR_BASE   (PA_LOCAL_PERIPHERAL_BASE + 0xD0)
#define IPI_CORE2_RD_CLR_BASE   (PA_LOCAL_PERIPHERAL_BASE + 0xE0)
#define IPI_CORE3_RD_CLR_BASE   (PA_LOCAL_PERIPHERAL_BASE + 0xF0)
