#ifndef _P_PL011_UART_REGS_H
#define _P_PL011_UART_REGS_H
...
#define UART_DR             (UART_BASE + UART_DR_OFFSET)
#define UART_FR             (UART_BASE + UART_FR_OFFSET)
#define UART_IBRD           (UART_BASE + UART_IBRD_OFFSET)
#define UART_FBRD           (UART_BASE + UART_FBRD_OFFSET)
#define UART_LCRH           (UART_BASE + UART_LCRH_OFFSET)
#define UART_CR             (UART_BASE + UART_CR_OFFSET)
#define UART_IMSC           (UART_BASE + UART_IMSC_OFFSET)
#define UART_ICR            (UART_BASE + UART_ICR_OFFSET)
