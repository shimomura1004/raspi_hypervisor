...
if [ "$BOARD" = "virt" ]; then
    DISPLAY=:0 qemu-system-aarch64 -m 1024 -M virt,gic-version=2 -cpu cortex-a53 -device loader,file=$KERNEL_IMG,addr=0x40100000 -nographic -serial mon:stdio -net none -s $*
else
